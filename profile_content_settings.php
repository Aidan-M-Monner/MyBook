        ...
        <form method="post" enctype="multipart/form-data">
            <?php 
                ...
                if(is_array($settings)) {
                    ...
                    echo "<select class='class-3-a' name='gender' style='height: 30px;'>
                            <option>" . htmlspecialchars($settings['gender']) . "</option>
                            <option>Male</option>
                            <option>Female</option>
                        </select>";
                    echo "<input type='text' name='email' class='class-3-a' placeholder='Email' value='" . htmlspecialchars($settings['email']) . "'/>";
                    echo "<input type='password' name='password' class='class-3-a' placeholder='Password' value='" . htmlspecialchars($settings['password']) . "'/>";
                    echo "<input type='password' name='password2' class='class-3-a' placeholder='Retype Password' value='" . htmlspecialchars($settings['password']). "'/>";
